...
// Não tem como mudar o valor(Constante)
const idade = 31;
...
// Não pode declarar variáveis assim:
// let 2teste = "inválido"
// let @teste = "inválido"
...
// Arredonda para baixo(5.0)
console.log(Math.floor(5.14));

// Arredonda para cima(6.0)
...
// Dispara um erro por meio de avisos no console
console.error("erro!");

// Aviso de como fazer algo, pode ser melhorado
console.warn("aviso!");
